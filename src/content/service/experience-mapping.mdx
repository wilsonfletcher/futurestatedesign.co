...
export const em = (props) => <em class="text-gray not-italic" {...props} />

export const components = { em }
...
<Article>
  <p class="lead">Design and visualise your optimal future customer journey – and understand
    what you need to make it happen.</p>
</Article>
...
<Section name="Questions">
  <Prose>
    <details>
      ...
      > We’ve run these programmes for as little
      as £15k and as much as £150k. We’ll give you a series of options that enable
      you to choose an approach that gives you the best balance of cost and outcome.
    </details>
    <details>
    ...
    <details>
      <summary>How will you work with us?</summary>
      > We’ve run these programmes for as little
      as £15k and as much as £150k. We’ll give you a series of options that enable
      you to choose an approach that gives you the best balance of cost and outcome.
    </details>
    ...
    <details>
      <summary>Can you support us long-term?</summary>
      > We’ve run these programmes for as little
      as £15k and as much as £150k. We’ll give you a series of options that enable
      you to choose an approach that gives you the best balance of cost and outcome.
    </details>
