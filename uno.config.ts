...
export default defineConfig({
  shortcuts: [
    ...
    { 'link': 'text-[1.625rem] leading-none hover:(underline)' },
    ...
    presetIcons({
      collections: {
        custom: {
          ...
          external: '<svg viewBox="0 0 20 20" fill="none"><path d="M5 15.751l10.26-10.26M15.149 5v10.26m-9.88-9.88h10.26" stroke="currentColor" stroke-width=".76"/></svg>',
