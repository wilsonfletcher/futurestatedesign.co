...
<div class="container foo pb-8">
  <div class="body lg:col-span-6 lg:col-start-3">
    <p class="h2">A specialist advisory and coaching programme for leaders of growth-stage digital startups.</p>
...
<section class="bg-yellow py-10">
  <div class="container foo">
    <div class="body lg:col-span-6 bg-red lg:col-start-3">
...
<section class="bg-qux text-white py-8 lg:py-16">
<div class="container foo">
  <H2 class="lg:col-span-2">Programme structure</H2>
  <div class="body lg:col-span-6">
...
<section class="bg-qux text-white py-8 lg:py-16">
  <div class="container foo">
    <H2 class="lg:col-span-2">Support when you need it</H2>
    <div class="body lg:col-span-6 md:grid md:grid-cols-2 md:gap-10">
      <article>
...
<section class="py-6 lg:py-8">
 <div class="container foo">
   <H2 class="lg:col-span-2">Why sign up?</H2>
   <div class="body lg:col-span-6">
      <p class="h2">Too many great ideas fail. Even more fail to reach their potential. Don’t be one of them.</p>
...
<section class="py-6 lg:py-8">
  <div class="container foo">
    <H2 class="lg:col-span-2">Get experts on your side.</H2>
    <div class="body lg:col-span-6">
      If we can help, we can help a lot. If we’re not right for you, we’ll tell you. Book a free 30 minute call.
...
<section>
  <div class="container foo">
    <H2 class="lg:col-span-2">Any questions?</H2>
    <div class="body lg:col-span-6">
...
<section>
  <div class="container foo">
    <H2 class="lg:col-span-2">Who we are</H2>
    <div class="body lg:col-span-6">
