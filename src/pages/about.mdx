...
seo:
  image:
    ...
    alt: Foo
---
import services from '@content/services/index.yml'
import Teaser from '@components/Teaser.astro'
import Foo from '@components/Foo.astro'

<p class="intro">We’ve been making new ideas work for 20 years. In that time, we’ve worked with
  over 150 organisations, in 10 countries, delivering over 350 successful
  programmes.</p>

<p class="lead">Founded as Wilson Fletcher by Mark Wilson and Stephanie Fletcher, we [became
  Futurestate Design Co.] to mark our 20th anniversary.</p>
...
![3-GRADES OF INNOVATION  diagram](/images/diagram.png)
