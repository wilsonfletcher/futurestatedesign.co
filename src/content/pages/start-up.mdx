...
url: /start-up
---
import Bled from '@/components/Bled.astro'
...
:::div{.lead}
You’ve started something great.<br />
Now you need to become something big.
...
Before you sign up, we do a free 30 minute call so we can make sure it’s right for you, and you can do the same.
:::
...
:::section{.bg-yellow.p-4.md-p-10.not-prose}
