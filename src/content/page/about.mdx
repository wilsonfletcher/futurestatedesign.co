...
<Banner>
<p class="lead"><span class="text-lime">Us?</span> We’ve been making new ideas work for 20 years. In that time, we’ve worked with over 150 organisations, in 10 countries, delivering over 350 successful programmes.</p>
...
<img src="/images/steph-mark.jpg" loading="lazy" width="1280" height="523" />
...
![alt](/images/grades-of-innovation.svg)

<PromoGroup name="Read" icon="article" class="mb-16">
  <Promo
...
- If you need a board advisor to add specialist expertise to your leadership team, we do that.
- If you need a team of specialists to work intensively on one critical programme for a few weeks or months, we do that.
- If you need help to design and deliver a multi-year strategy, with spikes in support at critical points, we do that.
- If you need a short, sharp intervention to overcome an urgent issue or de-risk a major initiative, we do that.
...
<p class="h3">Some of the key techniques we use in our work:</p>
...
<div class="mx-auto max-w-container">
  <img src="/images/about.jpg" class="" loading="lazy" alt="" />
</div>
