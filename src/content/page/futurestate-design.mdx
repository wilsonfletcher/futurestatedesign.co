...
{/* <figure class="figure max-w-container mx-auto mb-4">
  <img
    src="/images/daria-nepriakhina-zoCDWPuiRuA-unsplash.jpg"
    alt="Photo by Daria Nepriakhina 🇺🇦 on Unsplash"
  />
  <div class="grid gap-6 lg:gap-10 lg:grid-cols-8">
    <figcaption class:list="lg:col-span-6 lg:col-start-3">Photo by <a href="https://unsplash.com/@epicantus?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Daria Nepriakhina</a> 🇺🇦 on <a href="https://unsplash.com/">Unsplash</a></figcaption>
  </div>
</figure> */}
