...
export const description = 'Futurestate has been making new ideas work for 20 years. In that time, we’ve worked with over 150 organisations, in 10 countries, delivering over 350 successful programmes'
export const image = '/images/about-2.jpg'

<p class="not-prose h3">Founded as Wilson Fletcher by Mark Wilson and Stephanie Fletcher, we [became **Futurestate Design Co.**] to mark our 20th anniversary.</p> 

<p class="not-prose h3">The brand change reflects our renewed focus on business innovation, the growing success of our futurestate design methods, our love of bold ideas, and our mission to help every company we can become a successful innovator.</p>
